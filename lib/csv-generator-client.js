...
var getInstance = exports.getInstance = function getInstance(_ref) {
  ...
  var getDownloadLink = function getDownloadLink(dataArray) {
  ...
  var getLinkElement = function getLinkElement(fileName, dataArray) {
  ...
  this.download = function (fileName, dataArray) {
    ...
    if (window.navigator.msSaveBlob) {
      ...
      var linkElement = getLinkElement(fileName, dataArray);
